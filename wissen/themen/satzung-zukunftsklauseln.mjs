...
export default {
  ...
  verwandt: ["stiftung-governance", "satzungsaenderung-reform", "stifterwille-ewigkeit", "exit-aus-der-stiftung", "handlungsunfaehigkeit-unternehmer", "anlagerichtlinie-stiftung"],
};

...
export default {
  ...
  verwandt: ["vermoegensschutz-grenzen", "stiftung-von-todes-wegen", "zugewinn-stiftung", "pflichtteil-fristanlauf", "pflichtteilsstrafklausel", "pflichtteil-unternehmenswert"],
};

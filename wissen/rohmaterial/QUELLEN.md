...
Was an Material vorliegt, wann es kam und welche Themen daraus entstanden sind. Die
Dokumente selbst liegen **nicht** im Repository — es sind Verlagsveröffentlichungen mit
Nutzungsbeschränkung (NWB: „Die Veröffentlichung im Internet ist nicht gestattet"). Im
Repository stehen nur die daraus destillierten Themenskelette; kein Beitrag übernimmt
Wortlaut.

| Nr. | Dokument | Stand | Inhalt |
| --- | --- | --- | --- |
| Q1 | Die Familienstiftung in der Praxis (Teil 1) — Zivilrechtliche Grundlagen, Gestaltungsansätze, Satzungsgestaltung | 2026, final | Grundzüge, Einsatzmotive, Vor- und Nachteile, Vermögensschutz und seine Grenzen (Zugewinn, Pflichtteil, Anfechtung), Unternehmensnachfolge, Errichtung, Governance, Stifter und Begünstigte, Vermögensverwaltung, Beendigung |
| Q2 | Die Familienstiftung in der Praxis (Teil 2) — Steuerliche Behandlung von Errichtung, laufender Tätigkeit, Begünstigten und Beendigung | 2026, Zwischenstand | Lebenszyklus-Besteuerung: Errichtung (Steuerklassenprivileg, Verschonung, § 28a), Zustiftung, Dotation ertragsteuerlich, laufende Besteuerung, Destinatäre, Substanzauskehr, Ersatzerbschaftsteuer, Auflösung, Auslandsbezug |
...
Jedes Thema nennt in `quellen` die Nummer(n) oben. So lässt sich bei einer Rechtsänderung
rückwärts finden, welche Themen betroffen sind.

## Fremdmaterial und Aktualität

Q1 bis Q5 stammen vom Kanzleiinhaber selbst; Q7 bis Q9 sind für dieses Projekt erstellte
...
Gliederung und eigenprägende Formulierungen bleiben aussen vor. Die
Eigenständigkeitsprüfung greift hier nicht nur als Qualitätssicherung, sondern als
Notwendigkeit.

Q6 ist ausserdem von Juni 2024 und stellt Fragen, die seither beantwortet sind:

| In Q6 offen | Inzwischen entschieden |
| --- | --- |
| Steuerklassenprivileg nur für Inlandsstiftungen unionsrechtswidrig? Vorlage beim EuGH | EuGH 13.11.2025, C-142/24 — die Beschränkung ist zulässig |
| Können Stiftungen ihren Verwaltungssitz unter Wahrung der Rechtsfähigkeit verlegen? Revision anhängig | BFH 04.06.2025, II R 30/22 — massgeblich ist die zivilrechtliche Anerkennung als rechtsfähig |
| Gilt der Entlastungsbeweis auch für Drittstaaten? Revision anhängig | BFH 03.12.2024 — ja, wegen der Kapitalverkehrsfreiheit; Massstab ist zivilrechtlich, nicht wirtschaftlich |

**Die Themen bilden den Stand 2026 ab, nicht den von Q6.**

## Lücken

Mit Q9 sind alle Felder der Themenlandkarte abgedeckt. Der Weg dahin:

| Quelle | Geschlossen |
| --- | --- |
| Q1–Q6 | Familienstiftung, Ersatzformen, Liechtenstein, Lebenszyklus-Besteuerung |
| Q7 | Niessbrauch, Schenkungsverträge, Personen- und Kapitalgesellschaftsanteile, Unternehmertestament, Ehevertrag, Immobilien, Minderjährige, Verschonungstechnik |
...
lässt sich aus den vorhandenen Quellen ableiten — neues Material ist dafür nicht nötig.

## Noch zu erwarten

- „Praxis des Investmentsteuerrechts" — davon nur verwerten, was für Private Clients
  trägt: Wegzug, Unternehmens- und Vermögensnachfolge. Reine Fondsbesteuerung,
  Anlegertypologie und Betriebsstättenfragen bleiben draussen.

## Vorgaben des Kanzleiinhabers zu diesem Material
